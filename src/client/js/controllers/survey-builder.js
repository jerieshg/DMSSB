angular.module('app')
  .filter('range', function() {
  ...
  }).controller('surveyBuilderController', ['$scope', '$state', '$http', '$stateParams', 'commonFactory', function($scope, $state, $http, $stateParams, commonFactory) {
    ...
    function generateSurvey() {
      ...
      surveyModel.surveyId = commonFactory.randomString(32).toUpperCase();

      var customCSS = {
        navigationButton: "invisible"
      };
